...
Q3	Sum and Average of Array Elements	Calculates sum and average of array elements
Q4	Count Even and Odd Numbers	Counts even and odd numbers in an array
Q5	Linear Search	Searches an element in an array using linear search
Q6	Sort Array (Ascending Order)	Sorts a 1D array using bubble sort
Q7	Add Two 1D Arrays	Adds two arrays element-wise
...
Works for any size of array or matrix (modify inputs easily)

Includes 1D and 2D array operations
